...
function calcResult() {
  ...
  switch(currentRound) {
    case 0:
      result = currentResult === 1 ? '哎哟，你输了呀，我就说你出石头会输的嘛，哈哈哈~': 
               currentResult === 2 ? '这次我先让你，我们再来一局':
               '平局哦，再来'
      break;
    case 1:
      result = currentResult === 1 ? '好吧，我输了，再来，我不信下局还不能赢你': 
               currentResult === 2 ? '平局啊，再来，信不信下局我一定赢你':
               '哈哈，不好意思，一不小心就赢了你'
      break;
    case 2:
      result = currentResult === 1 ? '竟然平局，好吧': 
               currentResult === 2 ? '哈哈，别伤心，虽然你输了，但是后面有彩蛋哦~':
               '我不管，最后一局，是我让你，记住了吗'
      break;
  }
...
function choose(e) {
  ...
  yourChooseTextEle.innerHTML = `你要出“${fingerMap[currentResult-1]}”吗？你会输的哦~`
}
